...
export default function Home() {
  ...
  return (
    <div className="font-sans min-h-screen flex flex-col">
      {/* HERO SECTION */}
      <section className="relative w-full flex flex-col items-center justify-center text-center py-20 px-6 bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-2xl shadow-lg">
