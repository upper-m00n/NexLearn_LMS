...
export declare type StreamingResolution = "240" | "360" | "480" | "720" | "1080" | "1440" | "2160";
/**
...
export declare type Overlay = TextOverlay | ImageOverlay | VideoOverlay | SubtitleOverlay | SolidColorOverlay;
...
export declare type TextOverlayTransformation = {
    /**
...
export declare type SubtitleOverlayTransformation = {
    /**
...
export declare type SolidColorOverlayTransformation = Pick<Transformation, "width" | "height" | "radius"> & {
    /**
